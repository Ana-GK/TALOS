...
% INITIAL joint positions (forwards kinematics are calculated only once)
...
% Lowest value of force for Talos to move
lowest_F_value = 5;
...
x_up_limit = initial_cart_position(1,1) + 0.25;
x_low_limit = initial_cart_position(1,1) - 0.25;
...
z_up_limit = initial_cart_position(1,3) + 0.35;
z_low_limit = initial_cart_position(1,3) - 0.15;
...
while strcmp(swi1.Value,'On') % While the button is on
    ...
    K = 0.0005; % constant for integral
...
%     joint_positions = msg_states; % Save joint positions
    ...
    % Set position relative to initial

    new_cart_position(1,1) = initial_cart_position(1,1) + 0.05;
    new_cart_position(2,1) = initial_cart_position(1,1) + 0.05;
%     
%     new_cart_position(1,2) = initial_cart_position(1,2) + 0.10;
%     new_cart_position(2,2) = initial_cart_position(2,2) + 0.10;

    
    new_cart_position(1,3) = initial_cart_position(1,3) - 0.05;
    new_cart_position(2,3) = initial_cart_position(1,3) - 0.05;
