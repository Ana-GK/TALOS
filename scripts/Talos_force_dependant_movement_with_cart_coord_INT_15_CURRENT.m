...
while strcmp(swi1.Value,'On') % While the button is on
    ...
    % Set all the force components lower than lowest_F_value_component to 0
    ...
    % Checks if applied force is greater than lowest_F_value
